...
- need "ignore folders" in a media library, ie. to ignore /temp folder in torrents folder.

- make it easier to transfer data/cache directories (add better help... have simple 'data' vs 'stream' envs)
