...
@Module({
	...
	providers: [TmdbProvider, OmdbProvider, MetadataService, ImageService, FileProbeService],
	exports: [MetadataService, ImageService, TmdbProvider, OmdbProvider, FileProbeService],
})
