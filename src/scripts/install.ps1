...
function Download-Release {
    Write-Step "Phase 4: Downloading CineHost $($script:SelectedTag)"
...
function Build-Project {
    Write-Step "Phase 5: Building CineHost"
...
function Generate-Config {
    Write-Step "Phase 6: Generating configuration"
...
function Configure-Firewall {
    ...
    Write-Step "Phase 7: Opening firewall port $($script:ServerPort)"
